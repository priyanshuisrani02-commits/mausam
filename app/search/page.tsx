  ...
  return (
    <main className="min-h-screen bg-white px-8 py-12">
      <div className="mx-auto max-w-7xl">
        ...
        <h1 className="mb-3 text-5xl font-light text-black">
          Search Results
        </h1>
        ...
        {results.length === 0 ? (
          <div className="rounded-3xl border border-gray-200 p-12 text-center">
            <h2 className="mb-3 text-2xl font-light text-black">
              No products found
            </h2>
          ...
          {results.map((product: StoreProduct) => (

              <Link
                key={product.id}
                href={`/products/${product.id}`}
                className="overflow-hidden rounded-3xl border transition hover:shadow-xl"
              >
